        ...
        if (sender instanceof Player) {
            if (sender.hasPermission("intents.gamemode.creative")) {
                if (args.length == 0) {
                    ...
                    final String messaggio = this.plugin.getConfig().getString("Messagges.gmsp-msg").replaceAll("&", "§");
                    ...
                    if (p2 != null) {
                        if (p2 == sender) {
                            ...
                            final String messaggios = this.plugin.getConfig().getString("Messagges.gmsp-msg").replaceAll("&", "§");
